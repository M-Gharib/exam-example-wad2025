...
```
git clone  https://github.com/M-Gharib/exam-example-wad2025.git
```
...
You need to [import]( https://docs.github.com/en/get-started/importing-your-projects-to-github/importing-source-code-to-github/importing-a-repository-with-github-importer)   this [repository](https://github.com/M-Gharib/exam-example-wad2025.git)  to your GitHub account

**Note:** you have to be logged in to your GitHub account to do the following steps

- In the first field "Your old repository’s clone URL" enter URL of this repository https://github.com/M-Gharib/exam-example-wad2025.git
- In the "Your new repository details", give the repo a name (e.g., WAD-Yourname), and make it **Private**
